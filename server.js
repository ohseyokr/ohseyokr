...
app.get('/api/mypage/dashboard', authenticateToken, async (req, res) => {
  try {
    ...
    res.json({
      ...
      stats: {
        points: 12500, // Mock Data for Wireframe
        coupons: 3,    // Mock Data for Wireframe
        reviews: 24,   // Mock Data for Wireframe
        qna: 16        // Mock Data for Wireframe
      },
...
// Seed Initial Data (Maintained for DB consistency)
async function seedDemoData() {
  try {
    ...
    if (Number(userCheck.rows[0].count) === 0) {
      await db.query(`INSERT INTO public.users (id, email, name, role, status) VALUES ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'student@ohseyokr.com', 'Kim Minjun', 'MEMBER', 'ACTIVE'), ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'admin@ohseyokr.com', '관리자', 'ADMIN', 'ACTIVE')`);
    }
